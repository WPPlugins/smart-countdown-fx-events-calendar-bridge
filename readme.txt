...
Smart Countdown FX Events Calendar Bridge **requires [Smart Countdown FX][2] version 1.3 or higher**, please do not forget to update before proceeding.
...
For samples and complete documentation [see this page][1]
 ...
 [1]: http://wp.smartcalc.org/events-calendar-bridge/
...
<http://wp.smartcalc.org/events-calendar-bridge/> - complete list of attribute values for this shortcode has been provided to answer this exact question.
...
Added filter for events (posts) status. Only published events are imported.
